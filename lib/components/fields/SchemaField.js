...
function Label(props) {
  ...
  return _react2.default.createElement(
    "label",
    { className: cssPrefix + "__control-label", htmlFor: id },
...
function Help(props) {
  ...
  if (typeof help === "string") {
    return _react2.default.createElement(
      "p",
      { className: cssPrefix + "__help-block" },
      help
    );
  }
  return _react2.default.createElement(
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      errors.map(function (error, index) {
        return _react2.default.createElement(
          "li",
          { className: cssPrefix + "__text-danger", key: index },
          error
        );
      })
    )
...
function DefaultTemplate(props) {
  var id = props.id,
      ...
      cssPrefix = props.formContext.cssPrefix;
  ...
  return _react2.default.createElement(
    ...
    displayLabel ? _react2.default.createElement(Label, { label: label, required: required, id: id, cssPrefix: cssPrefix }) : null,
...
function SchemaField(props) {
  ...
  var cssPrefix = _ramda2.default.prop('cssPrefix', formContext);

  //  console.log('cssPrefix', cssPrefix)
  var classNames = [cssPrefix + "__form-group", cssPrefix + "__field", cssPrefix + "__field-" + type,
  //    errors && errors.length > 0 ? "field-error has-error" : "",
  //    errors && errors.length > 0 && !formContext.preview ? "field-error has-error" : "",
  errors && errors.length > 0 && !formContext.preview ? cssPrefix + "__field-error" : "", uiSchema.classNames].join(" ").trim();
  ...
  var fieldProps = {
    ...
    help: _react2.default.createElement(Help, { help: help, cssPrefix: cssPrefix }),
    rawHelp: typeof help === "string" ? help : undefined,
    errors: _react2.default.createElement(ErrorList, { errors: errors, cssPrefix: cssPrefix }),
    rawErrors: errors,
    id: id,
    label: label,
    hidden: hidden,
