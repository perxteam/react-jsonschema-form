...
var DateTimeInputWidget = function (_React$Component) {
  ...
  function DateTimeInputWidget() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DateTimeInputWidget.__proto__ || Object.getPrototypeOf(DateTimeInputWidget)).call.apply(_ref, [this].concat(args))), _this), _this.renderInput = function () {
      ...
      var _ref2 = value ? value.split('.') : [],
          ...
          _ref3$ = _ref3[0],
          day = _ref3$ === undefined ? '' : _ref3$,
          _ref3$2 = _ref3[1],
          month = _ref3$2 === undefined ? '' : _ref3$2,
          _ref3$3 = _ref3[2],
          year = _ref3$3 === undefined ? '' : _ref3$3;
  ...
  _createClass(DateTimeInputWidget, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          inputProps = _objectWithoutProperties(_props, ['id', 'value', 'readonly', 'autofocus', 'onChange', 'options', 'schema', 'formContext', 'registry']);
      ...
      return _react2.default.createElement(_reactDatetime2.default, {
        ...
        onChange: function onChange(value) {
          _onChange2(formatDateCustom(format)(value));
        },
