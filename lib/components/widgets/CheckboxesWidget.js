...
function CheckboxesWidget(props) {
  ...
  return _react2.default.createElement(
    "div",
    { className: cssPrefix + "__checkboxes", id: id },
    enumOptions.map(function (option, index) {
      var checked = value.indexOf(option.value) !== -1;
      var disabledCls = disabled ? cssPrefix + "__disabled" : "";
      var checkbox = void 0;
      ...
      return inline ? _react2.default.createElement(
        "label",
        { key: index, className: cssPrefix + "__checkbox-inline " + disabledCls },
        checkbox
      ) : _react2.default.createElement(
        "div",
        { key: index, className: cssPrefix + "__checkbox " + disabledCls },
        _react2.default.createElement(
          "label",
          null,
          checkbox
